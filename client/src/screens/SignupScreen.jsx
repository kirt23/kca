...
function CreateTextField({type, label, placeholder, startIcon, endIcon, onFocus, onBlur, onChange, error, helperText, value}) {
	return (
		<TextField
			value={value}
			error={error}
...
useEffect(() => {
	...
	return (
		<>{true ? (<div className="registration-design">
				<div className="bg-registration"></div>
				<div className="registration-card">
					<Form onSubmit={submiteHandler}>
						<h2 style={{marginTop: '30px'}}><center>CUSTOMER REGISTRATION</center></h2>
						<hr style={{borderBottom: '3px solid #111', width: '40%', marginLeft: '30%'}}/>
						<Form.Group controlId="name">
							<div style={{display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', columnGap: '10px'}}>
									<CreateTextField type="name" placeholder="First Name" onChange={(e) => setName(e.target.value)}/>
									<CreateTextField type="middlename" placeholder="Middle Name" onChange={(e) => setMiddleName(e.target.value)}/>
									<CreateTextField type="lastname" placeholder="Surname" onChange={(e) => setLastName(e.target.value)}/>
							</div>
						</Form.Group>
						<Form.Group controlId="bdayGender">
							<div style={{display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', columnGap: '10px'}}>
									<CreateTextField type="suffix" placeholder="Suffix" onChange={(e) => setSuffix(e.target.value)}/>
									<CreateTextField type="date" placeholder="MM/DD/YYYY"
						...
						<Form.Group controlId="email">
							<CreateTextField type="email" placeholder="Email"
								onChange={handleEmailChange}
								error={Boolean(emailError)}
								helperText={emailError}/>
						</Form.Group>
						<Form.Group controlId="password">
							<CreateTextField type="password" placeholder="Password" onChange={(e) => setPassword(e.target.value)}/>
						</Form.Group>
						...
						<Form.Group controlId="confirmPassword">
							<CreateTextField type="Password" placeholder="Confirm Password" onChange={(e) => setConfirmPassword(e.target.value)}/>
						</Form.Group>
						<button type="submit" className="registration-button">REGISTER</button>
						<span><center style={{marginTop: '10px'}}>Or</center></span>
